...
//        mBleLisenter = bleLisenter;
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            Log.e(TAG, "Service connection successful，服务绑定成功init BlueTooth");
...
//    }
    ...
    public boolean sendData(String address, String ssid, String mPass) {
        ...
        synchronized (mLocker) {
            if (mBluetoothLeService != null) {
                result = mBluetoothLeService.writeCharacteristic(address, dataByte);
            }
            return result;
        }
    }
    ...
    public boolean sendDataDefault(String address, String mDefault) {
        byte[] dataByte = mDefault.getBytes();
        boolean result = false;
        synchronized (mLocker) {
            if (mBluetoothLeService != null) {
                result = mBluetoothLeService.writeCharacteristic(address, dataByte);
